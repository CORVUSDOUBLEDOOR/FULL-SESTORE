...
public class SE_STORE9 {
    ...
    public static void main(String[] args) throws IOException {
        File txtProduct = new File("C:\\Users\\User\\IdeaProjects\\SE_STORE\\src\\PRODUCT (4).txt");
        ;
        ...
        int countProduct = 0;
        File category = new File("C:\\Users\\User\\IdeaProjects\\SE_STORE\\src\\CATEGORY.txt");
                                ...
                                while (loopOrNot == true) {
                                    ...
                                    if (typeNumber.equalsIgnoreCase("1")) {
                                                        ...
                                                        while (loopCheckout == true) {
                                                            if (typeChooser.equalsIgnoreCase("1")) {
                                                                ...
                                                                System.out.printf("\t===========================================\t\n" +
                                                                        ...
                                                                        "\t1. Confirm\n" +
                                                                        "\t2. Cancel\n" +
                                                                        "\tEnter : ",priceTotal, priceTotal + 50);
                                                                typeChooser = inputTypeChooser.next();
                                                                if (typeChooser.equalsIgnoreCase("1")){
                                                                    System.out.print("\tThank you for your purchase\n");

                                                                    updateFile_Cart();
                                                                    createNewOrder(member[correctIndex].getIdUser(),userIdIndexCart);
                                                    ...
                                                    if (line[1].charAt(0) == '+') {
                                                        ...
                                                        if (newOrder) {
                                                            if (product[Integer.parseInt(line[0]) - 1].getQuantity() - numberQuantityProduct < 0) {
                                                                ...
                                                                createNewCart(member[correctIndex].getIdUser(), product[Integer.parseInt(line[0]) - 1].getId(), numberQuantityProduct);
                                                        ...
                                                        if (newOrder) {
                                                            if (product[Integer.parseInt(line[0]) - 1].getQuantity() - quantity_input < 0) {
                                                                ...
                                                                createNewCart(member[correctIndex].getIdUser(), product[Integer.parseInt(line[0]) - 1].getId(), quantity_input);
                                        ...
                                        for(int i = 0 ; i < product.length; i++){
                                            int countingTrue = 0;
                                            try {
                                                if(product[i].getNameProduct().toLowerCase().contains(searhProductName.toLowerCase())){
                                                    countingTrue++;
                                                    searchingTrue = true;
                                                    indexSearch.add(i);
                                                }
                                        ...
                                        if (typeNumber.equalsIgnoreCase("1")) {
                                            ...
                                            while (loopAddMember) {
                                                ...
                                                if (checkAddmember == true) {
                                                    //generate password
                                                    FileWriter writer = new FileWriter("C:\\Users\\User\\IdeaProjects\\SE_STORE\\src\\MEMBER (5).txt", true);
                                                    ...
                                                    try {
                                                        ...
                                                        if (chooseUserEditNumber >= 1 && chooseUserEditNumber <= member.length) {
                                                            ...
                                                            if (checkEdit == true) {
                                                                ...
                                                                BufferedWriter editMembered = new BufferedWriter(new FileWriter("C:\\Users\\User\\IdeaProjects\\SE_STORE\\src\\MEMBER (5).txt", false));
                                                                for (int i = 0; i < member.length; i++) {
                                                    ...
                                                    try {
                                                        ...
                                                        if (chooseProductEditNumber >= 1 && chooseProductEditNumber <= product.length) {
                                                            ...
                                                            if (checkEdit == true) {
                                                                ...
                                                                BufferedWriter editProducted = new BufferedWriter(new FileWriter("C:\\Users\\User\\IdeaProjects\\SE_STORE\\src\\PRODUCT (4).txt", false));
                                                                for (int i = 0; i < product.length; i++) {
    ...
    public static void AddCartToFile(String newLine) {
        try (BufferedWriter writer = new BufferedWriter(new FileWriter("C:\\Users\\User\\IdeaProjects\\SE_STORE\\src\\CART.txt", true))) {
    ...
    public static void createNewCart(String userID, String productID, int quantity) throws FileNotFoundException {
    ...
    public static void updateFile_Cart() {
        Cart[] backUpOrder = cart;
        try (BufferedWriter writer = new BufferedWriter(new FileWriter("C:\\Users\\User\\IdeaProjects\\SE_STORE\\src\\CART.txt", false))) {
    ...
    public static void loadFileCart() throws FileNotFoundException{
        File cartReader = new File("C:\\Users\\User\\IdeaProjects\\SE_STORE\\src\\CART.txt");
    ...
    public static void AddOrderToFile(ArrayList<String> newLine) {
        try (BufferedWriter writer = new BufferedWriter(new FileWriter("C:\\Users\\User\\IdeaProjects\\SE_STORE\\src\\ORDER.txt", true))) {
            for(int i = 0 ; i < newLine.size() ; i++) {
                writer.write(newLine.get(i));
            }
        } catch (IOException e) {
            e.printStackTrace();
        }
    ...
    public static void createNewOrder(String userID, ArrayList<Integer> userIndexCart) throws FileNotFoundException {
        int index_Order;
        loadFileOrder();
        if(order.size() != 0){
            index_Order = (Integer.parseInt(order.get(order.size()-1).substring(0,4)))+1;
        }else{
            index_Order = 8001;
        }
        ArrayList <String> newOrder = new ArrayList<String>();
        for(int i = 0 ; i < cart.length ; i++){
            if(cart[i].getUserID().equalsIgnoreCase(userID)){
                double costProductOrder = 0.00;
                for (int j = 0; j < product.length; j++) {
                    if (cart[i].getProductID().equalsIgnoreCase(product[j].getId())) {
                        costProductOrder = product[j].getCost();
                    }
                }

                newOrder.add(index_Order + "\t" + userID + "\t" + cart[i].getProductID() + "\t" + cart[i].getQuantity() + "\t$" + costProductOrder + "\n");
            }
        }


        AddOrderToFile(newOrder);
        loadFileOrder();
        updateFile_Order();
        clearCart(userIndexCart);
    }

    public static void updateFile_Order() {
        ArrayList<String> Order = order;
        try (BufferedWriter writer = new BufferedWriter(new FileWriter("C:\\Users\\User\\IdeaProjects\\SE_STORE\\src\\ORDER.txt", false))) {
    ...
    public static void loadFileOrder() throws FileNotFoundException{
        File orderReader = new File("C:\\Users\\User\\IdeaProjects\\SE_STORE\\src\\ORDER.txt");
        Scanner inputOrder = new Scanner(orderReader);

        inputOrder.close();
        inputOrder = new Scanner(orderReader);
        order = new ArrayList<String>();

        while (inputOrder.hasNextLine()) {
            String line = inputOrder.nextLine();
            order.add(line);
        }
    }
    ...
    public static void updateFile_product(){
        ...
        try (BufferedWriter writer = new BufferedWriter(new FileWriter("C:\\Users\\User\\IdeaProjects\\SE_STORE\\src\\PRODUCT (4).txt",false))){
    ...
    public static void readMember() throws FileNotFoundException {
        File memberReader = new File("C:\\Users\\User\\IdeaProjects\\SE_STORE\\src\\MEMBER (5).txt");
    ...
    public static void clearCart (ArrayList <Integer> userIdIndexCart){
        for(int i = 0; i < userIdIndexCart.size() ; i++) {
            cart[userIdIndexCart.get(i)].setQuantity(0);
